...
<div class="searchContainer">
    ...
    <form action="../phpMotasem/cart.php"> <button  id="shoppingCart"><img src="../icons/shoppingCart.png"></button></form>
</div>
...
<div class="containerCategories">
    ...
    <form method="post" action="userPanelHoodie.php">
<?php
session_start();
...
$q="select * from products where type ='هودي';";
$x=mysqli_query($c,$q);
$data=array(array());
